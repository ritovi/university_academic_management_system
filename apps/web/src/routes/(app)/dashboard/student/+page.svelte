<script lang="ts">
	...
	import { studentNavGroups } from '$lib/components/config/studentNav';
	let { children } = $props();
...
<DashboardLayout>
	{#snippet sidebar()}
		<AppSidebar navGroups={studentNavGroups} />
	{/snippet}
	...
	{#snippet headerContent()}
		<Breadcrumb.Root>
			<Breadcrumb.List>
				<Breadcrumb.Item>
					<Breadcrumb.Link href="/dashboard/student">Estudiante</Breadcrumb.Link>
				</Breadcrumb.Item>
